...
void initGPIO(void){
	...
	//Write your logic here
	wiringPiISR(23, INT_EDGE_FALLING,hourInc);
	wiringPiISR(24, INT_EDGE_FALLING,minInc);
...
int main(void){
	...
	wiringPiI2CWriteReg8(RTC, HOUR_REGISTER,getHours());
	wiringPiI2CWriteReg8(RTC, MIN_REGISTER,getMins());
	wiringPiI2CWriteReg8(RTC, SEC_REGISTER,getSecs());
	...
	for (;;){
		...
		//if(mins > 60) { mins =decCompensation(mins);}
		//if(hours > 23){hours = 0;} 
		//Toggle Seconds LED
		//Write your logic here
